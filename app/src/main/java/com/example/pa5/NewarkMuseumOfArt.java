...
public class NewarkMuseumOfArt extends AppCompatActivity {
    ...
    private int SENIOR_PRICE = 13;
    private int STUDENT_PRICE = 10;
    private int ADULT_PRICE = 20;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(NewarkMuseumOfArt.this, "Maximum Of 5 Tickets For Each!", Toast.LENGTH_SHORT).show();
        ...
        seniorText.setText(getResources().getText(R.string.NMOA_senior));
        studentText.setText(getResources().getText(R.string.NMOA_student));
        adultText.setText(getResources().getText(R.string.NMOA_adult));
